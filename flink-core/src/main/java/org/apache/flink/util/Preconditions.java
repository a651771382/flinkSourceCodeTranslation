...
public final class Preconditions {
	 ...
	 * 违反时将抛出没有消息的{@code NullPointerException}。
	 *
	 * @param reference The object reference reference对象引用
	 * @return The object reference itself (generically typed). 对象引用类型（一般类型）
